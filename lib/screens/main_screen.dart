...
//import 'package:plant_app/screens/home_screen_test.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            GestureDetector(
              child: CircleAvatar(
                backgroundColor: MyThemeData.kDarkGreenColor,
                radius: 22.0,
      ...
      bottomNavigationBar: CustomBottomNavBar(
        ...
        selectedColor: MyThemeData.kDarkGreenColor,
        unselectedColor: MyThemeData.kSpiritedGreen,
        onTapped: (index) {
          setState(() {
            selectedIndex = index;
          });
